  ...
  useEffect(() => {
    ...
    const updateCountdown = () => {
      ...
      if (timeSinceLastClaim >= twentyFourHours) {
        ...
        setTimeUntilNextClaim("Պատրաստ է!")
      } else {
        ...
        setTimeUntilNextClaim(`${hours}ժ ${minutes}ր ${seconds}վ`)
      }
    }
              ...
              <div className="space-y-3">
                <Card className="p-4 border-2 border-yellow-500/50">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <div className="font-bold text-lg text-foreground">VIP Առաջադրանք</div>
                      <div className="text-sm text-muted-foreground">Կատարեք և վաստակեք մեծ գումար</div>
                    </div>
                    <div className="text-2xl">⭐</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold text-yellow-500">֏50,000</div>
                    <Button className="bg-yellow-500 hover:bg-yellow-600 text-white">Սկսել</Button>
                  </div>
                </Card>
                ...
                <Card className="p-4 border-2 border-orange-500/50">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <div className="font-bold text-lg text-foreground">Շաբաթական մարտահրավեր</div>
                      <div className="text-sm text-muted-foreground">Կատարեք 50 առաջադրանք շաբաթվա ընթացքում</div>
                    </div>
                    <div className="text-2xl">🏆</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold text-orange-500">֏100,000</div>
                    <Button className="bg-orange-500 hover:bg-orange-600 text-white">Սկսել</Button>
                  </div>
                </Card>
                ...
                <Card className="p-4 border-2 border-red-500/50">
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <div className="font-bold text-lg text-foreground">Ամսական բոնուս</div>
                      <div className="text-sm text-muted-foreground">Ակտիվ մնացեք ամբողջ ամիսը</div>
                    </div>
                    <div className="text-2xl">🎁</div>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold text-red-500">֏250,000</div>
                    <Button className="bg-red-500 hover:bg-red-600 text-white">Սկսել</Button>
                  </div>
                </Card>
              </div>
            </Card>
          ...
          <div className="space-y-3">
            ...
            {[1, 2, 3, 4, 5].map((task) => (
              <Card key={task} className="p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <h3 className="font-semibold text-foreground mb-1">Առաջադրանք #{task}</h3>
                    <p className="text-sm text-muted-foreground">Կատարեք առաջադրանքը և վաստակեք ֏2,000</p>
                  </div>
                  <Button
                    onClick={() => {
          ...
          <div className="space-y-3">
            ...
            {[1, 2, 3, 4].map((video) => (
              <Card key={video} className="p-4 hover:shadow-lg transition-shadow">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <h3 className="font-semibold text-foreground mb-1">Տեսանյութ #{video}</h3>
                    <p className="text-sm text-muted-foreground">Դիտեք տեսանյութը և վաստակեք ֏2,300</p>
                  </div>
                  <Button
                    onClick={() => {
        ...
        {activeTab === "payments" && (
          <div className="space-y-4">
            ...
            <Card className="p-6">
              ...
              <div className="bg-muted/50 p-4 rounded-lg mb-4">
                <p className="text-sm text-muted-foreground mb-2">Նվազագույն գումար: ֏125,000</p>
